...
.login-intro p:not(.eyebrow) { max-width: 480px; color: #aebbd1; font-size: 12px; }
...
.login-footnote { margin: var(--space-3) 0 0; color: var(--color-muted); font-size: 12px; text-align: center; }
