...
import AdminSearchInput from "@/shared/components/AdminSearchInput.vue";
...
vi.mock("@/features/notifications/api", () => ({
  notificationsApi: { listNotifications, getNotification, mode: "mock" },
}));
...
describe("NotificationsPage", () => {
  ...
  it("renders list metadata without notification body", async () => {
    ...
    const wrapper = mount(NotificationsPage, { global: { stubs: testStubs } });
    await flushPromises();
