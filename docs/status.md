...
- 2026-08-15：权利材料 SHA-256 长度收入契约 `RIGHTS_MATERIAL_DIGEST_LENGTH=64`；DTO、发布闸门、编辑页 maxlength/pattern 与 Mock 保存共用 `isRightsMaterialDigest`。不把灰度指标写成已接入。
