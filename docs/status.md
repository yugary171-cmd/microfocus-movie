...
- 2026-08-16：微信开发者工具 iOS 真机自动调试报 `41002 appid missing`，确认原因是内部 Mock 产物使用 `touristappid` 且真机启动侧未配置真实 AppID；README 已明确游客 AppID 仅用于模拟器/Mock，真实 AppID 需由开发者在本机工具或私有配置中填写，不写入仓库。
